...
#classes allow for the creation of tools which can be repeated with varying inputs
#they create a framework which can be flexibly manipulated further downstream